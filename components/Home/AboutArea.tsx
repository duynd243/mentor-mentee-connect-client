          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-5">
              <div className="about__content pl-70 pr-25">
                ...
                <p>
                  Not only can university offer an environment rich in our
                  social an cultural experiences.
                </p>

                <div className="about__list mb-40">
                  <ul>
                    <li>
                      <i className="fa-solid fa-check"></i> Access to all our
                      courses
                    </li>
                    <li>
                      <i className="fa-solid fa-check"></i> Learn the latest
                      skills
                    </li>
                    <li>
                      <i className="fa-solid fa-check"></i> Upskill your
                      organization
                    </li>
                  </ul>
                </div>
