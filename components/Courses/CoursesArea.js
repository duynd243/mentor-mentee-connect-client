...
const CourseArea = () => {
  ...
  let uniqueCategory = [
    "All Categories",
    ...new Set(allCourseItems?.map((course) => course.category)),
  ];
  // currentPage
  ...
  const { data: categoryItems, isLoading } = useQuery(
    ["categories", category],
    () => categoryApi.getAllCategories(category)
  );
  // courseItems
  let courseItems = categoryItems?.slice(
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    <div className="course__view text-end">
                      <h4>{`Showing 1 - ${courseItems?.length || 0} of ${
                                        ...
                                        <div className="course__right p-relative">
                                          <div className="course__content p-relative">
                                            ...
                                            <div className="course__summary">
                                              <p>
                                                Communia virtutes tutiorem
                                                declarat stoicorum sanabat
                                                oblivisci nostris tamquam
                                                iucunditatem
                                              </p>
                                            </div>
                        ...
                        .map((categoryItem, index) => {
                          return (
                            <li key={index}>
                              <div
                                onClick={() =>
                                  handleCategoryFilter(categoryItem)
                                }
                                className="course__sidebar-check mb-10 d-flex align-items-center"
                              >
                                <input
