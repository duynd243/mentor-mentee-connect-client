...
const Header = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (query) {
      router.push(`/search-courses/${query}`);
    } else {
      console.log();
    ...
    <>
      <header>
        <div className="header__area">
          <div className="header__top header__border d-block py-2">
            <div className="container">
              <div className="row align-items-center">
                ...
                <div className="col-md-6 col-12">
                  <div className="header__top-right d-flex justify-content-end align-items-center gap-3">
                    {user?.email &&
