...
const CourseDetails = () => {
  ...
  // query payment info
  useEffect(() => {
    if (courseData?._id && user?.email) {
      fetch(
        `https://obscure-shelf-38503.herokuapp.com/paymentInfo?email=${user?.email}&&id=${courseData?._id}`
      )
        .then((res) => res.json())
        .then((data) => {
            ...
            <div className="col-xxl-8 col-xl-8 col-lg-8">
              <div className="course__wrapper">
                <div className="page__title-content mb-25">
                  ...
                  <h5 className="breadcrumb__title-2">{courseData?.title}</h5>
                </div>
                <div className="course__meta-2 d-sm-flex align-items-center mb-30">
                  <div className="course__teacher-3 d-flex align-items-center mr-70 mb-30">
                    <div className="course__teacher-thumb-3 mr-15">
                      <img src={courseData?.teacher_img} alt="" />
                    </div>
                    <div className="course__teacher-info-3">
                      <h5>Teacher</h5>
                      <p>
                        <a href="#">{courseData?.tutor_name}</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="course__rating-2 mb-30">
                    ...
                    <div className="course__rating-inner d-flex align-items-center">
                      ...
                      <p>{courseData?.review}</p>
                    </div>
                  </div>
                </div>
                <div className="course__img w-img mb-30">
                  <img src={courseData?.img_bg} alt="" />
                </div>
