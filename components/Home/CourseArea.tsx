...
const CourseArea = () => {
  ...
  const { data: allCoursesItems, isLoading } = useQuery(
    "courses",
    courseApi.getAllCourses
  );
  console.log(allCoursesItems);
  return (
    <>
                  ...
                  <div className="course__tab-wrapper">
                    <div className="row">
                      {isLoading ? (
                        ...
                        allCoursesItems?.slice(0, 6).map((course: any) => {
                          const {
                            img_bg,
                            price,
                            title,
                ...
                >
                  <div className="row">
                    {isLoading ? (
                      ...
                      allCoursesItems?.slice(6, 12).map((course: any) => {
                        const {
                          img_bg,
                          price,
                          title,
                ...
                >
                  <div className="row">
                    {isLoading ? (
                      ...
                      allCoursesItems?.slice(8, 14).map((course: any) => {
                        const {
                          img_bg,
                          price,
                          title,
                ...
                >
                  <div className="row">
                    {isLoading ? (
                      ...
                      allCoursesItems?.slice(3, 9).map((course: any) => {
                        const {
                          img_bg,
                          price,
                          title,
                ...
                >
                  <div className="row">
                    {isLoading ? (
                      ...
                      allCoursesItems?.slice(5, 11).map((course: any) => {
                        const {
                          img_bg,
                          price,
                          title,
