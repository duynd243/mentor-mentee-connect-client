...
const CategoryArea = () => {
  return (
    <>
      <section className="category__area pt-105 pb-70">
            ...
            <div className="col-xxl-4 col-xl-4 col-lg-4">
              <div className="category__wrapper">
                ...
                <div className="category__btn">
                  <Link href="/courses">
                    <a className="tp-btn-5">Browse all categories</a>
                  </Link>
                </div>
              </div>
            </div>
                ...
                <div className="row">
                  <SingleCategory
                    icon={
                      ...
                      >
                        ...
                        />
                        <path
                          d="M13.9606 3.59143L8.78467 8.76734"
                          stroke="#4270FF"
                          strokeWidth="1.56"
                          strokeLinecap="round"
                        />
                        <path
                          d="M26.3688 16.0137L22.228 20.1404"
                          stroke="#4270FF"
                          strokeWidth="1.56"
                          strokeLinecap="round"
                        />
                  ...
                  <SingleCategory
                    icon={
                      ...
                      >
                        ...
                        />
                        <path
                          d="M19.2849 6.77502H23.6799V11.155"
                          stroke="#FF6470"
                          strokeWidth="1.6"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <SingleCategory
                    icon={
                      ...
                      >
                        <path
                          d="M21.3334 10.6666H10.6667V21.3333H21.3334V10.6666Z"
                          stroke="#F37F43"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                    <div className="category__item text-center mb-45">
                      ...
                      <div className="category__content">
                        <h4 className="category__title add">
                          <Link href="/courses">
                            <a>All</a>
                          </Link>
                        </h4>
