...
const FixedBottomEnroll = ({ userData, courseData, totalSessions }) => {
  ...
  return (
    <div className="bottom__course__wrapper d-lg-none fixed-bottom px-4 py-3 text-white">
      <div className="row">
        <div className="col-8">
          <div className="d-flex flex-column flex-md-row align-items-md-center-center gap-2 gap-md-3">
            <div className="bottom__course__subject px-2 rounded">
          ...
          <div className="bottom__course__info d-flex align-items-start gap-4 gap-md-5 mt-3">
            <div className="bottom__course__teacher d-flex align-items-center gap-3">
              <img
                ...
                src={courseData?.mentor?.imageUrl}
                alt=""
              />
            ...
            <div className="d-flex align-items-center gap-2">
              <div className="d-none d-sm-block bottom__course__students">
                ...
                <div className="bottom__course__students__enrolled text-center">
                  ...
                  {courseData?.currentNumberMentee > 1 ? "Students" : "Student"}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-4">
          <div className="d-flex flex-column flex-md-row justify-content-end align-items-center gap-4 h-100">
            <h3 className="bottom__course__price">
              <BeanIcon fillColor="white" />
              {courseData?.price}
            </h3>
            {userData?.roleId !== constants.roles.mentor.id && (
              <button
                type="button"
                onClick={handleShow}
                className="bottom__course__enroll btn btn-primary py-2 px-3 py-md-3 px-md-4"
              >
                Enroll Now
              </button>
            )}
