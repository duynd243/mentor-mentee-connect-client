...
const CounterArea = () => {
  return (
    <>
      <section className="counter__area pt-120">
          ...
          <div className="counter__inner grey-bg-2">
            <div className="row">
              <SingleCounter
                ...
                number={17}
                subtitle="Years of Language Education Experience"
              />
              ...
              <SingleCounter
                ...
                number={26}
                subtitle="Innovative Foreign Online Courses"
              />
              ...
              <SingleCounter
                ...
                number={44}
                subtitle="Qualified Teachers and language experts"
              />
              ...
              <SingleCounter
                ...
                number={52}
                subtitle="Learners Enrolled in Educal Courses"
                border="border-0"
              />
            </div>
          </div>
